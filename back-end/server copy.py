...
training_data = [
    ...
    ('what is your name', 'I\'m an AI chatbot. You can call me ChatBot.'),
    ...
    ('yes', 'Certainly! Please hold on while I connect you to a representative.'),
    ('order', 'How can I assist you with the order?'),
    ('help', 'How can I assist you?'),
    ('need assistance', "Sure, I'm here to help. What do you need?"),
    ('talk to a representative', 'Certainly! Please hold on while I connect you to a representative.'),
    ('speak to a human', 'I can connect you to a human representative. Please wait for a moment.'),
    ('I want to speak to a person', "I'll connect you with a representative. Please wait a moment."),
    ('tell me about shipping', 'Our shipping policy ensures that your products are delivered within the specified timeframe.'),
    ('what are the payment options', 'We accept various payment methods including credit cards, debit cards, and PayPal.'),
    ('how can I track my order', 'You can track your order by visiting the "Order Tracking" page on our website and entering your order details.'),
...
def handle_accept_query(customer_id):
    ...
    tokens = nltk.FreqDist(preprocessed_input)
    response = classifier.classify(tokens)
    if any(keyword in message.lower() or keyword in response for keyword in ["representative", "human", "yes", "person"]):
        ...
        response = {"sender":"Chatbot", "message":response}
